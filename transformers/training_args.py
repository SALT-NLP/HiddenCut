...
class TrainingArguments:
    ...
    **which relate to the training loop itself**.
    ...
    early_stop: int = field(
        default=-1,
        metadata={"help": "If > 0: set early stop point"},
    )
    ...
    aug_type: Optional[str] = field(default='span_cutoff', metadata={'help': 'choices {span_cutoff, token_cutoff, dim_cutoff, hidden_span_cutoff}'})
